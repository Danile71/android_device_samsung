...
$(call inherit-product-if-exists, vendor/samsung/serranoveltexx-common/serranoveltexx-common-vendor.mk)
								

# Common overlay
DEVICE_PACKAGE_OVERLAYS += device/samsung/serranoveltexx-common/overlay
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/permissions/com.cyanogenmod.nfc.enhanced.xml:system/etc/permissions/com.cyanogenmod.nfc.enhanced.xml \
